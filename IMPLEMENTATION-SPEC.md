...
| 3 | Use case | Paragraph | Yes (min 100 chars) | 2000 | How you plan to use the integration and what problem it solves (100 characters minimum). Describe the use case only - do not paste actual records, credentials, or Confidential data. | Data-minimization wording is required at entry (F1). |
| 4 | Approximately how many people would use this connector? | Single-select radios: 1-10 / 11-100 / 101-1,000 / All of Syracuse University / Other | No | - | - | Breadth of use is a review factor (F1). |
...
| 9 | Steps taken to confirm there is no SOC 2 report | Paragraph | Conditional (shown when #6 = "The vendor does not have one"), required, min 100 chars | 1000 | Describe what you did to look for the report (checked the trust center or security page, searched the web, asked vendor support), and include any and all links to the sites you checked (100 characters minimum). | Lets ITS verify the vendor genuinely has no report before it is ruled out; the links let ITS re-check directly. |
